...
public class UrlDialog extends Dialog {
    ...
    EditTextPlus edtUrl, edtTitle;

    public UrlDialog(@NonNull Activity activity) {
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtUrl = findViewById(R.id.edt_link);
        edtTitle = findViewById(R.id.edt_link_title);
        ...
        findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                urlDialogListener.onInsertUrl(title, Url);
                dismiss();
            }
        });
    ...
    public void setOnInsertDialogListener(UrlDialogListener onSaveListener) {
        this.urlDialogListener = onSaveListener;
    }
